    ...
    def _extract_as_text(self, data: Any, **kwargs) -> str:
        ...
        try:
            if isinstance(data, pd.DataFrame):
                ...
                text_kwargs = {k: v for k,
                               v in kwargs.items() if k != "format"}
                ...
                text_kwargs = {
                    k: v for k, v in kwargs.items() if k not in ["format", "headers"]
                }
    ...
    def _extract_as_html(self, data: Any, **kwargs) -> str:
        ...
        try:
            if isinstance(data, pd.DataFrame):
                ...
                html_kwargs = {
                    k: v for k, v in kwargs.items() if k in valid_html_params
                }
    ...
    def _extract_as_json(self, data: Any, **kwargs) -> Dict:
        ...
        try:
            if isinstance(data, pd.DataFrame):
                ...
                json_kwargs = {
                    k: v for k, v in kwargs.items() if k not in ["format", "index"]
                }
                ...
                json_kwargs = {
                    k: v for k, v in json_kwargs.items() if k in valid_params
                }
