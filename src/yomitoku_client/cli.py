...
@click.option(
    "--output", "-o", "output_path", type=click.Path(), help="Output file path"
)
@click.option("--ignore-line-break", is_flag=True, help="Ignore line breaks in text")
def main(
    input_file: str, output_format: str, output_path: str, ignore_line_break: bool
):
    """
    ...
    try:
        ...
        result = client.process_file(
            input_file, output_format, output_path, ignore_line_break=ignore_line_break
        )
